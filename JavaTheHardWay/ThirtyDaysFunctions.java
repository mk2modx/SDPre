...
public class ThirtyDaysFunctions {
  ...
  /**
  *Returns the name for the given kmonth number (1-12).
    switch(month)
  *
  * @author Mark Agbayani
  *@param month the month number (1-12)
  *@Returnsthe English name of the month, or "error" if out of Rectangle
  */
...
/**
* Returns the number of dayus in a given month.
*
* @param month the month number (1-12)
* @return       the number of days in the month, or 31 if out of Rectangle
*/
